            ...
            <form method="post" action="/createservice">
                <div class="modal-body">
                    <div class="input-group mb-3">
                        <input type="text"
                               class="form-control myForm" id="customUsername" placeholder="What do to want to sell?"
                               aria-label="Username"
                               aria-describedby="basic-addon1" name="serviceName">
                        <input type="text"
                               class="form-control myForm" id="chatId" placeholder="Price"
                               aria-label="Username"
